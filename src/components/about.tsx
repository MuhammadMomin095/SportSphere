    ...
    <section className="py-16">
      <div className="containe mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div
  className="relative h-[400px] sm:h-[500px] lg:h-[600px] w-full rounded-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 ease-in-out"
  style={{
...
>
  ...
  <div className="absolute bottom-6 left-6 right-6">
    <p className="text-white text-xl sm:text-2xl font-semibold">
      Empowering athletes with top-notch gear
    </p>
  </div>
</div>
          </div>
